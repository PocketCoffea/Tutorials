...
cfg = Configurator(
    ...
    preselections = [get_nObj_min(1, minpt=30., coll="JetGood")],
    categories = {
        "1j_1b": [ get_nObj_min(1., minpt=50., coll="JetGood"), get_nObj_min(1, 30., coll="BJetGood")],
        "2j_1b": [ get_nObj_min(2., minpt=50., coll="JetGood"), get_nObj_min(1, 30., coll="BJetGood")],
    },
    ...
    columns = {
        "common": {
            "inclusive" : [ColOut(coll="JetGood", columns=["pt","eta","phi"] , flatten=True )]     }
    },
)
